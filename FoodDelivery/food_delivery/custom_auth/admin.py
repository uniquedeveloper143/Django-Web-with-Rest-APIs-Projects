...
admin.site.site_title = 'Food Admin Panel'
admin.site.index_title = 'Food Delivery Admin Panel'
...
class UserAdmin(UserAdmin):
    ...
    fieldsets = (
        ('Personal info', {'fields': ('uuid', 'phone', 'username', 'name', 'email', 'password')}),
    ...
    list_display = ('username', 'name', 'phone', 'email', '_get_password', 'uuid', 'last_user_activity', 'is_online')
    search_fields = ('username', 'email', 'phone', 'uuid', 'name')
    list_filter = ('username', 'email', 'phone', 'uuid', 'name')
