# Generated by Django 3.2 on 2022-05-26 06:47

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import django.utils.timezone
import music_video.custom_auth.managers
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', music_video.custom_auth.managers.ApplicationUserManager()),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration_time', models.DateTimeField(default=music_video.custom_auth.utils.set_password_reset_expiration_time)),
